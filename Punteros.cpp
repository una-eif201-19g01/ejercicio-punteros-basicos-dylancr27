...
float Punteros::RaizCuadradaValor(float numra) {
    numra = (sqrt(numra));
    return numra;
}

float Punteros::RaizCuadradaPuntero(float *numraPtr) {
    *numraPtr = (sqrt(*numraPtr));
    return *numraPtr;
}

float Punteros::RaizCuadradaReferencia(float& numraPtr){
    numraPtr= (sqrt(numraPtr));
    return numraPtr;
}
...
void Punteros::imprimirRaizCuadradaValor() {
    float numero = 0;
    ...
    numero = raizCuadradaValor(numero);

    std::cout << "\n\tEl resulado al cubo de la variable [ numero ] es: " << numero << std::endl;
}


void Punteros::imprimirRaizCuadradaPuntero() {
    float numero = 0;
    ...
    numero = raizCuadradaPuntero(&numero);

    std::cout << "\n\tEl resulado al cubo de la variable [ numero ] es: " << numero << std::endl;
}

void Punteros::imprimirRaizCuadradaReferencia() {
    float numero = 0;
    ...
    numero = raizCuadradaReferencia(numero);
